      ...
      {cameras.map((camera, index) => (
        ...
        >
            ...
            <div className={cn(
              ...
              <div className="flex items-center justify-center gap-2">
                <Button
                  size="sm"
                  variant="ghost"
                  className="bg-neutral-800/80 hover:bg-neutral-700/80 text-white"
                  onClick={(e) => {
                    e.stopPropagation()
            ...
            {camera.status === 'online' && playingStates[camera.id] && (
              <div className="absolute top-4 right-4">
                <motion.div
                  ...
                  className="flex items-center gap-2 px-3 py-1 bg-red-500/20 border border-red-500/30 rounded-full"
                >
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <div className="bg-neutral-900/50 rounded-xl px-4 py-3 text-center border border-neutral-800">
